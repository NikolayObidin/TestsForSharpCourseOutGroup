...
namespace Lab2.Tests
{
    public class Tests
    {
        ...
        {
            AClassTest[] objs = { new ClassTest1("Alice", 4), new ClassTest1("Alice", 4), new ClassTest2("Tom", 6) };
        ...
        {
            Interface[] objs = { new ClassTest1("Alice", 4), new ClassTest1("Alice", 4), new ClassTest2("Tom", 6) };
            string[] tempString = new string[objs.Length];
            for (int i = 0; i < objs.Length; i++)
            {
